        ...
        <div class="content-wrapper">
            ...
            <div class="dashboard-inner-saction">
                    ...
                    <div class="overview-profile-method">
                        <ul class="method-row">
                                        ...
                                        <div data-ml-modal id="update_profile_email">
                                            ...
                                            <div class="modal-dialog modal-dialog-lg">
                                                ...
                                                <div class="modal-content newspaper">
                                                    <form class="form-popup" id="update_profile_email" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="submit_email_res"></div>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li>
                                ...
                                <div class="method-row-right">
                                <div class="popup-box">
                                        <a href="#update_profile_password" class="link"> Reset Password</a>
                                        <div data-ml-modal id="update_profile_password">
                                            ...
                                            <div class="modal-dialog modal-dialog-lg">
                                                ...
                                                <div class="modal-content newspaper">
                                                    <form class="form-popup" id="update_profile_password" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="input-popup-row">
                                                        ...
                                                        <div class="from-button">
                                                            ...
                                                            <div class="submit_password_res"></div>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                ...
                <div class="overview-saction">
                    ...
                    <form class="form-popup" id="submit_profile_details" action="{{ route('submit.profile.details')}}" method="POST"
                                                enctype="multipart/form-data">
                        @csrf
                            <div class="edit-profile">
                                <img src="{{ asset('storage/'. $user_details->avatar) }}" />
                                <button class="edite-profile"><img
                                        src="{{ asset('themes/tailwind/customer/assets/images/edit.png') }}" /></button>
                                <button class="close-profile"><img
                                        src="{{ asset('themes/tailwind/customer/assets/images/close-image.png') }}" /></button>
                            </div>
                            <div class="from-input-row">
                                <div class="from-input">
                                    <label>Name</label>
                                    <input type="text" name="fname" value="{{$user_details->name}}" placeholder="" />
                                </div>
                                <div class="from-input">
                                    <label>Country</label>
                                    <div class="select">
                                        <select name="country">
                                            ...
                                            <option value="1" <?php if($user_details->country == '1') echo"selected";?>>Afghanistan</option>
                                            <option value="2" <?php if($user_details->country == '2') echo"selected";?>>Albania</option>
                                            <option value="3" <?php if($user_details->country == '3') echo"selected";?>>Algeria</option>
                                ...
                                <div class="from-input">
                                    ...
                                    <div class="select">
                                        <select name="language">
                                            ...
                                            <option value="1">Albanian (Shqip)</option>
                                            <option value="2">Arabic (اَلْعَرَبِيَّةُ) </option>
                            ...
                            <div class="save-profile-button"><button type="submit">Save</button></div>
                        </form>
                        @if(session('success'))
                        ...
                        <div class="ebay-account-box-right">
                            <div class="radio-box">
                                <label class="switch" for="ebay_checkbox">
                                    <input type="checkbox" id="ebay_checkbox" name="ebay_checkbox"
                                        class="ebay_checkbox">
                                    <div class="slider round"></div>
                                </label>
                            </div>
                            <div class="popup-box is_ebay_connection" style="display:none;">
                                                    ...
                                                    <div class="select">
                                                        <select name="ebay_user_marketplace" id="ebay_user_marketplace"
                                                            ...
                                                            <option value="Belgium (Française) -- befr.ebay.be">Belgium
                                                                (Française) -- befr.ebay.be</option>
                                                            <option value="Belgium (Nederlandse) -- benl.ebay.be">
                                                                Belgium (Nederlandse) -- benl.ebay.be</option>
                                                            <option value="Canada (Française) -- cafr.ebay.ca">Canada
                                                                (Française) -- cafr.ebay.ca</option>
